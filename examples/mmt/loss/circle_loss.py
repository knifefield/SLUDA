...
class SparseCircleLoss(nn.Module):
    def __init__(self, in_feat: int, class_num: int, m: float, gamma: float) -> None:
        ...
        self.weight = nn.Parameter(torch.FloatTensor(self.class_num, self.in_feat))
...
if __name__ == "__main__":
    ...
    SparseCircle = SparseCircleLoss(m=0.25, in_feat=128, class_num=10, gamma=64)
